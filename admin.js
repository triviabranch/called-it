...
button.onclick = async () => {
  ...
  try {
    ...
    result.hidden = false;
  } catch (error) { configStatus.textContent = error.message || "Refresh failed."; }
