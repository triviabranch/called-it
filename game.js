...
async function bootLanding() {
  app.innerHTML = '<header class="brand"><a href="/" aria-label="Called It home"><img src="assets/called-it-wordmark.png" alt="Called It"></a><span class="room">LIVE MATCHDAY</span></header><div class="eyebrow">LIVE GAMES · THE MATCHDAY EDITION</div><h1>Pick a fixture.<br><i>Call it live.</i></h1><p class="muted">These are live or imminent matches. Join before kick-off and make your calls while the game unfolds.</p><section class="card"><div class="section-head"><h2>Live Now</h2><span class="live-list-status"><span class="live-dot"></span>LIVE</span></div><div id="fixtures"><p class="muted">Loading this week’s live games…</p></div></section><p class="fine-print">No host. No private room to create. The fixture is the room.</p>';
