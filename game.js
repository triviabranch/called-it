...
async function bootLanding() {
  app.innerHTML = '<header class="brand"><a href="/" aria-label="Called It home"><img src="assets/called-it-wordmark.png" alt="Called It"></a><span class="room">LIVE MATCHDAY</span></header><div class="eyebrow">LIVE GAMES · THE MATCHDAY EDITION</div><h1>Pick a fixture.<br><i>Call it live.</i></h1><section class="card"><div class="section-head"><h2>Live Now</h2><div class="fixture-list-actions"><label class="fixture-region"><span>TV in</span><select data-fixture-region aria-label="TV region"><option value="gb">United Kingdom</option><option value="au">Australia</option><option value="us">United States</option><option value="ca">Canada</option><option value="nz">New Zealand</option><option value="ie">Ireland</option></select></label><span class="live-list-status"><span class="live-dot"></span>LIVE</span><button type="button" class="fixture-refresh" data-fixture-refresh aria-label="Refresh fixture list" title="Refresh fixture list">↻</button></div></div><div id="fixtures"><p class="muted">Loading this week’s live games…</p></div></section>';
