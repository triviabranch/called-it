...
async function bootLanding() {
  app.innerHTML = '<header class="brand">CALLED IT <span class="room">LIVE MATCHDAY</span></header><div class="eyebrow">THE MATCHDAY EDITION</div><h1>Pick a fixture.<br><i>Call it live.</i></h1><p class="muted">Choose a supported fixture, join before kick-off and make your calls while the match unfolds.</p><section class="card"><div class="section-head"><h2>Fixtures</h2></div><div id="fixtures"><p class="muted">Loading this week’s fixtures…</p></div></section><p class="fine-print">No host. No private room to create. The fixture is the room.</p>';
