...
async function bootLanding() {
  app.innerHTML = '<header class="brand"><a href="/" aria-label="Called It home"><img src="assets/called-it-wordmark.png" alt="Called It"></a><span class="room">LIVE MATCHDAY</span></header><div class="eyebrow">LIVE GAMES · THE MATCHDAY EDITION</div><h1>Pick a fixture. <i>Call it live.</i></h1><section class="card"><div class="section-head"><h2 class="fixture-list-title">Live now</h2><div class="fixture-list-actions"><label class="fixture-region"><span>TV in</span><select data-fixture-region aria-label="TV country"><option value="gb" aria-label="United Kingdom" title="United Kingdom">🇬🇧</option><option value="au" aria-label="Australia" title="Australia">🇦🇺</option><option value="us" aria-label="United States" title="United States">🇺🇸</option><option value="ca" aria-label="Canada" title="Canada">🇨🇦</option><option value="nz" aria-label="New Zealand" title="New Zealand">🇳🇿</option><option value="ie" aria-label="Ireland" title="Ireland">🇮🇪</option></select></label><span class="live-list-status"><span class="live-dot"></span>LIVE</span><button type="button" class="fixture-refresh" data-fixture-refresh aria-label="Refresh fixture list" title="Refresh fixture list">↻</button></div></div><div id="fixtures"><p class="muted">Loading this week’s live games…</p></div></section>';
